(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AirballoonsComponent = /** @class */ (function () {
                function AirballoonsComponent() {
                }
                AirballoonsComponent.prototype.ngOnInit = function () {
                };
                return AirballoonsComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BalloonFormComponent = /** @class */ (function () {
                function BalloonFormComponent(colorsService) {
                    this.colorsService = colorsService;
                    this.colors = [];
                    this.selectedColorCode = '';
                }
                BalloonFormComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    this.colorsService.getAllColors().subscribe(function (data) {
                        data.forEach(function (item) {
                            _this.colors.push(item);
                        });
                    });
                };
                return BalloonFormComponent;
            }());
            BalloonFormComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BalloonsListComponent = /** @class */ (function () {
                function BalloonsListComponent(router, currentRoute) {
                    this.router = router;
                    this.currentRoute = currentRoute;
                    this.balloons = [];
                }
                BalloonsListComponent.prototype.ngOnInit = function () {
                };
                BalloonsListComponent.prototype.addBalloonClick = function () {
                    this.router.navigate(['balloon-form']);
                };
                return BalloonsListComponent;
            }());
            BalloonsListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ColorFormComponent = /** @class */ (function () {
                function ColorFormComponent(colorsService) {
                    this.colorsService = colorsService;
                ...
                ColorFormComponent.prototype.formSubmit = function () {
                    if (this.formColor.valid) {
                        this.colorsService.addColor(this.formColor.value).subscribe(function (response) {
            ...
            ColorFormComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ColorsListComponent = /** @class */ (function () {
                function ColorsListComponent(service, router, currentRoute) {
                    this.service = service;
                    this.router = router;
                    this.currentRoute = currentRoute;
                    this.colors = [];
                }
                ColorsListComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.service.getAllColors().subscribe(function (data) {
                        data.forEach(function (item) {
                            _this.colors.push(item);
                        });
                    });
                };
                ColorsListComponent.prototype.addColor = function () {
                    this.router.navigate(['color-form']);
                };
                return ColorsListComponent;
            }());
            ColorsListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ColorsService = /** @class */ (function () {
                ...
                ColorsService.prototype.handleError = function (error) {
                ...
                ColorsService.prototype.addColor = function (color) {
